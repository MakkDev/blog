...
export default function Write() {
   ...
   const blogImageRef2 = ref(storage, `/blogPostImages2/` + v4()  + "-blog image")
   const blogImageRef3 = ref(storage, `/blogPostImages3/` + v4()  + "-blog image")
   ...
   const handleImg1Submit = () => {
    uploadBytes(blogImageRef, imageObject)
    .then(() => { 
    getDownloadURL(blogImageRef)
    .then(url => {setPostImg1(url);}); 
    setImageObject(null)
    setImageUploaded(true)
    })
}
   const handleImg2Submit = () => {
    uploadBytes(blogImageRef2, imageObject)
    .then(() => { 
    getDownloadURL(blogImageRef2)
    .then(url => {setPostImg2(url);}); 
    setImageObject(null)
    setImageUploaded(true)
    })
}
   const handleImg3Submit = () => {
    uploadBytes(blogImageRef3, imageObject)
    .then(() => { 
    getDownloadURL(blogImageRef3)
    .then(url => {setPostImg3(url);}); 
    setImageObject(null)
    setImageUploaded(true)
    })
}
   const handleThumbnailSubmit = () => {
    ...
    .then(() => { 
    getDownloadURL(blogThumbnailRef)
    ...
    const createPost = async () => {
        await addDoc(singleCollectionRef, 
            {title, postText1, postText2, postText3, postText4, postDate, postCategory, thumbnailUrl, postImg1, postImg2, postImg3, imgDesc1, imgDesc2, imgDesc3 });  
         navigate("/");
    ...
    return (
        ...
        <div className='write'>           
                <div className='writeFormGroup'>
                    ...
                    <input id='fileInput' type="file" style={{ display: "none" }} onChange={(e) => handleImageObject(e)} />
                    <button className='submitButton' onClick={() => handleThumbnailSubmit()}>  Submit Thumbnail  </button>    
                ...
                <div className='paragraph1'>
                    <textarea className='textInput' placeholder="Paragraph 1" type="text" 
                        ...
                        <button className='submitButton' onClick={() => handleImg1Submit()}>  "Submit Image 1"  </button>    
                        <input type="text" onChange={(event) => {setImgDesc1(event.target.value); }} placeholder="Image Description"/>
                ...
                <div className='paragraph2'>
                    <textarea className='textInput' placeholder="Paragraph 2" type="text" 
                        ...
                        <input type="file" onChange={(e) => handleImageObject(e)} />
                        <button className='submitButton' onClick={() => handleImg2Submit()}>  "Submit Image 2"  </button>    
                        <input type="text" onChange={(event) => {setImgDesc2(event.target.value); }} placeholder="Image Description" />
                ...
                <div className='paragraph3'>
                    <textarea className='textInput' placeholder="Paragraph 3" type="text" 
                        ...
                        <input type="file" onChange={(e) => handleImageObject(e)} />
                        <button className='submitButton' onClick={() => handleImg3Submit()}>  "Submit Image 3"  </button>    
                        <input type="text" onChange={(event) => {setImgDesc3(event.target.value); }} placeholder="Image Description" />               
                <div className='paragraph4'>
                    <textarea className='textInput' placeholder="Paragraph 4" type="text" 
                        onChange={(event) => {setPostText4(event.target.value);}}></textarea>             
                </div>
                </div>
